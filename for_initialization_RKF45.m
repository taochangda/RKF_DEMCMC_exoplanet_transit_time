...
addAttachedFiles(pool,[source_file_path,'Nbody_C_7Np_RKF45.mexw64']);
...
parfor loop_1=1:n_link 
    [tr,error_flag]=Nbody_C_7Np_RKF45(p_para(loop_1,:),mc,Rs,tstop,time_precise,err); %CALL funtion Nbody_C_7Np_RKF45  调用函数Nbody_C_7Np_RKF45进行凌星时间求解
